...
var AntCascader = function (_React$Component) {
  ...
  function AntCascader(props) {
    ...
    var _this = _possibleConstructorReturn(this, (AntCascader.__proto__ || Object.getPrototypeOf(AntCascader)).call(this, props));
  ...
  _createClass(AntCascader, [{
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          otherProps = _objectWithoutProperties(_props2, ['prefixCls', 'children', 'placeholder', 'size', 'disabled', 'className', 'style', 'allowClear']);
