  ...
  _createClass(Transfer, [{
    ...
    value: function handleSelectAll(direction) {
      var _splitDataSource2 = this.splitDataSource(),
          leftDataSource = _splitDataSource2.leftDataSource,
          rightDataSource = _splitDataSource2.rightDataSource;
    ...
    value: function handleSelect(direction, selectedItem, checked) {
      var _state4 = this.state,
          leftCheckedKeys = _state4.leftCheckedKeys,
          rightCheckedKeys = _state4.rightCheckedKeys;
    ...
    value: function render() {
      ...
      var _state5 = this.state,
          ...
          leftCheckedKeys = _state5.leftCheckedKeys,
          rightCheckedKeys = _state5.rightCheckedKeys;

      var _splitDataSource3 = this.splitDataSource(),
          leftDataSource = _splitDataSource3.leftDataSource,
          rightDataSource = _splitDataSource3.rightDataSource;
